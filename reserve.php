...
<form action="reserve.php" method="post">
    <label style="color: black;" for="permis">Permis:</label>
    ...
    <label style="color:black;" for="marque">Marque:</label>
    ...
    <label style="color:black;" for="model">Model:</label>
    ...
    <label style="color:black;" for="date_sortie">Date Sortie:</label>
    <input type="date" name="date_sortie" required>

    <label style="color:black;" for="date_entree">Date Sortie:</label>
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit_reservation"])) {
    ...
    $conn = new mysqli($dbhost, $dbuser, $dbpass, $dbname);
        ...
        $insertQuery = "INSERT INTO reservation (permis,marque, model, date_sortie, date_entrée)
                        VALUES ('$permis', '$marque','$model', '$date_sortie', '$date_entree')";
