...
<body>
    <div class="login-container">
        ...
        <p style="color: White;">Don't have an account? <a style="color: aqua;" href="signup.php">Sign Up</a></p>
        <p style="color: White;">Are you an admin ? <a style="color: aqua;" href="admin.php">Click here</a></p>
    </div>
